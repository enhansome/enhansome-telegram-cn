# Awesome Telegram CN with stars
...
* [@weatherman\_bot](https://telegram.me/weatherman_bot) - 显示您所在城市的天气。
...
* [@zodiac\_bot](https://telegram.me/zodiac_bot) - 显示你的星座运势。
* [@movie\_adviser\_bot](https://telegram.me/movie_adviser_bot) - 每天提供评分最高的电影。
* [@Cashgamebot](https://telegram.me/Cashgamebot) - 电报机器人中的第一个在线赌场。
* [@github\_gist\_bot](http://t.me/github_gist_bot) - 将文本和文档上传到GitHub Gist。
* [@nosticker\_bot](https://t.me/nosticker_bot) - 删除发布到该组的任何贴纸
* [@daysandbox\_bot](https://t.me/daysandbox_bot) - 删除最近24小时内加入群组的用户的链接组合帖子
...
* [@minegame\_bot](https://telegram.me/minegame_bot) – 直接在你的聊天中玩经典益智游戏。
...
* [python-telegram-bot](https://github.com/python-telegram-bot/python-telegram-bot) ⭐ 29,413 | 🐛 33 | 🌐 Python | 📅 2026-08-16 – 我们已经为你开发了一个你无法拒绝的封装库
* [pyTelegramBotAPI](https://github.com/eternnoir/pyTelegramBotAPI) ⭐ 8,762 | 🐛 3 | 🌐 Python | 📅 2026-08-16 – 一个简单但可扩展的Python实现
...
* [python-telegram-handler](https://github.com/sashgorokhov/python-telegram-handler) ⚠️ Archived – 一个python日志记录处理程序，通过Telegram Bot Api发送日志。
* [permabots](https://permabots.readthedocs.io/en/latest/) – 将即时消息机器人（Telegram，Kirk和Messenger）连接到您的API。

#### Javascript/Node

* [node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) ⭐ 9,200 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-16 – NodeJS的Telegram Bot API
* [Telegraf](https://github.com/telegraf/telegraf) ⭐ 9,176 | 🐛 79 | 🌐 TypeScript | 📅 2025-01-11 – Telegram bot框架（javascript，node.js）
...
* [ts-telegraf-decorators](https://github.com/panarama360/ts-telegraf-decorators) ⚠️ Archived – 这是一个简单的库，允许你使用装饰器和TypeScript。基于telegraf

#### .Net (C#)

* [TLSharp](https://github.com/sochix/TLSharp) ⚠️ Archived – 在C＃中实现的客户端库。
* [telegram.bot](https://github.com/MrRoundRobin/telegram.bot) ⭐ 51 | 🐛 1 | 🌐 C# | 📅 2023-03-14 – Telegram Bot API - C# Client

#### Rails

* [telegram-bot-ruby](https://github.com/atipugin/telegram-bot-ruby) ⭐ 1,425 | 🐛 0 | 🌐 Ruby | 📅 2026-08-02 – 用于Telegram的Bot API的Ruby封装
...
* [php-telegram-bot](https://github.com/akalongman/php-telegram-bot) ⭐ 4,020 | 🐛 84 | 🌐 PHP | 📅 2025-03-20 – 基于官方Telegram Bot API的PHP Telegram Bot
* [telegram-bot-sdk](https://github.com/irazasyed/telegram-bot-sdk) ⭐ 3,304 | 🐛 28 | 🌐 PHP | 📅 2026-07-25 – Telegram Bot API PHP SDK。让您轻松构建Telegram Bots！
* [TelegramBot/Api](https://github.com/TelegramBot/Api) ⭐ 1,192 | 🐛 65 | 🌐 PHP | 📅 2025-07-10 – Telegram BOT API的原生PHP封装

#### Go

* [telebot](https://github.com/tucnak/telebot) ⭐ 4,631 | 🐛 65 | 🌐 Go | 📅 2026-06-16 – 用Go编写的Telegram bot框架
...
* [TelegramBots](https://github.com/rubenlagus/TelegramBots) ⭐ 5,507 | 🐛 196 | 🌐 Java | 📅 2026-08-12 – 使用 Telegram Bots API 创建机器人的 Java 库
...
* [tgbot-cpp](https://github.com/reo7sp/tgbot-cpp) ⭐ 1,185 | 🐛 70 | 🌐 C++ | 📅 2026-08-13 – Telegram bot API 的 C++ 库
...
* [shell2telegram](https://github.com/msoap/shell2telegram) ⭐ 168 | 🐛 0 | 🌐 Go | 📅 2025-08-22 - 来自命令行的Telegram bot构造函数

## 群组

* [@awesometelegram](https://telegram.me/awesometelegram) – 官方小组
* [@javascript\_ru](https://t.me/javascript_ru) - Javascript
* [@css\_ru](https://t.me/css_ru) - 讨论 CSS 并解决问题
* [@frontend\_ru](https://t.me/frontend_ru) - 网络前端开发者社区
* [@pythontelegrambotgroup](https://telegram.me/pythontelegrambotgroup) – 围绕python-telegram-bot库进行讨论的官方小组
* [@flowtype\_ru](https://telegram.me/flowtype_ru) - JS的流式静态检查器
* [@geeksChat](https://telegram.me/geeksChat) – 关于电报，科技新闻和机器人的讨论
* [@macOS\_ru](https://telegram.me/macOS_ru) - 关于macOS（俄语）的讨论
...
* [hacker\_news\_feed](https://telegram.me/hacker_news_feed) – 来自Hacker News的热门新闻
